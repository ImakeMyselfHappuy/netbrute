...
printf "\n"
printf "\e[1;77m\e[45m   NetGang | Insta brute forcer.   \e[0m\n"
printf "\n"
}
...
checkroot
dependencies
read -p $'\e[1;92mVictims Username: \e[0m' user
...
read -p $'\e[1;92mPassword List (Enter to read from default): \e[0m' wl_pass
